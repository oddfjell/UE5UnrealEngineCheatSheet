...
#include "ToturialCharacter.generated.h"

UCLASS()
class SOLARSYSTEM_API AToturialCharacter : public ACharacter
{
	GENERATED_BODY()
...
#include "ToturialCharacter.h"

// Sets default values
AToturialCharacter::AToturialCharacter()
{
...
// Called when the game starts or when spawned
void AToturialCharacter::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AToturialCharacter::Tick(float DeltaTime)
{
...
// Called to bind functionality to input
void AToturialCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
